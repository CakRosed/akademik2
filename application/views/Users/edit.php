        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <?php 
                echo form_open_multipart('users/edit', 'role="from"');
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <?php echo cmb_dinamis('level', 'tbl_level_user', 'nama_level', 'id_level_user', $user->id_level_user, 'class="form-control"'); ?>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="form-group">
                      ...
                      <div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
                          <div class="fileupload-new thumbnail" style="width: 150px; height: 125px;"><img src="<?php echo base_url('upload/user/'.$user->foto); ?>" alt="">
                          </div>
