        ...
        <!-- navbar dinamis -->
          <?php
            ...
            foreach($main_menu as $main){
              ...
              {
                // jika ada submenu sesuai id mainmenu, tampilkan mainmenu disini
                echo "<li class='treeview'>
                      ...
                      <ul class='treeview-menu'>";
                        ...
                        foreach($sub_menu->result() as $sub){
                          // dan tampilkan sub menu disini
                          echo "<li>
                                ".anchor($sub->link,
                                  "<i class='".$sub->icon."'></i>".ucwords($sub->nama_menu))."
                                </li>";
                        }
              ...
              {
                //  jika nilai 0 maka tampilkan main menu saja
                echo "<li>".anchor($main->link,
                      "<i class='".$main->icon."'></i>
                      <span>".$main->nama_menu."</span>")."
                    </li>";
              }
